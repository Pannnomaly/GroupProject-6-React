...
export default function UserComponent() {
  return (
    <div className="h-200 w-full flex justify-center font-earn">
        <div className="w-[25%] bg-(--color-main3) mt-10 mb-10 gap-10 flex flex-col justify-center items-center text-(--color-main12)">
        ...
        <div className="w-[65%] bg-(--color-main5) mt-10 mb-10 flex flex-col justify-center items-center">
