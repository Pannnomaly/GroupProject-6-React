        ...
        <SidebarProvider>
            ...
            <div className="m-5 flex flex-col gap-6 w-full md:px-0">
                ...
                <div id="block-2" className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div id="RA" className="bg-primary-foreground rounded-lg h-fit min-h-32 p-5 flex flex-col gap-2">
                        <p className="font-bold">Recent Activites</p>
                        <div id="scrolling-RA" className="flex flex-col gap-2 max-h-56 overflow-y-auto pr-2">
                            <div className="p-2">
                                <p>Activity 1</p>
                    ...
                    <div id="PT" className="bg-primary-foreground rounded-lg h-fit min-h-32 p-5 flex flex-col gap-2">
                        <p className="font-bold">Pending Tasks</p>
                        <div id="scrolling-PT" className="flex flex-col gap-2 max-h-56 overflow-y-auto pr-2">
                            <div className="p-2">
                                <p>Task 1</p>
