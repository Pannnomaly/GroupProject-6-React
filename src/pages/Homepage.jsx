    ...
    <div>
          ...
          >
            ...
            >
              ...
              <p className="text-[#333333] leading-relaxed mb-6">
                From the moment you arrive, you are welcomed with warmth,
                comfort, and a gentle sense of ease🍃 <br />
              </p>
      ...
      <div className="bg-[#EFEDEA] text-[#333333] font-serif">
        <header className="fixed top-0 w-full z-50 px-4 sm:px-6 md:px-10 py-6 flex justify-between items-center text-[#EFEDEA] mix-blend-difference">
          ...
          <a href="/">
            <img src="hotel-logo.png" alt="Hotel Logo" className="h-10 pl-10 md:pl-40" />
          </a>
        ...
        <section className="relative w-full h-screen overflow-hidden">
          ...
          <motion.div
            ...
            style={{ scale }}
          >
            <p className="text-5xl sm:text-6xl md:text-8xl lg:text-[140px] leading-none  mb-4 opacity-30 ">
              S.
            </p>
        ...
        <section className="px-8 sm:px-16 md:px-32 py-16 sm:py-20 md:py-24 bg-[#ffff]">
          <div className="text-center">
            <p className="text-2xl sm:text-3xl md:text-4xl tracking-wider mb-5 text-[#958574]">
              Sleepy Monkey Hotel Bangkok{" "}
            </p>
            <p className="text:xl sm:text-xl md:text-xl tracking-wider mb-10 text-[#958574]">
              Surrounded by the city, we welcome you into a softer, calmer place
              to rest and feel at home{" "}
            </p>
            <Link to="roomdetail">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[#6C5B5C] leading-relaxed mb-10 tracking-wide">
                Leave the noise behind and immerse yourself in a serene city
                view.
                <br />
                From gentle morning sunlight to calming evening skies,
                <br />
                our space offers a simple sanctuary infused with the quiet charm
                of urban life.
              </p>
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            >
              <p className="text-lg sm:text-xl leading-relaxed mb-10 tracking-wide text-[#333333]">
                ...
                <br />
                thoughtfully selected ingredients and inspired creations await
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 ">
              <div>
                ...
                <div className="text-m leading-relaxed  mt-6 text-gray-800 space-y-4">
                  <p>
                    <span className="font-semibold">Single Room</span> — A cozy
                    room with one bed, perfect for solo travelers who want
                    privacy and comfort.
                  </p>
                  <p>
                    <span className="font-semibold">Double Room</span> — Ideal
                    for two guests, available with either one double bed .
                  </p>
                  <p>
                    <span className="font-semibold">Twin Room</span> — Ideal for
                    two guests, available with two single beds.
                  </p>
                </div>
              </div>
